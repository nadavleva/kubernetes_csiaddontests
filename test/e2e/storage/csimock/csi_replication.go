...
var _ = utils.SIGDescribe("CSI replication", func() {
	...
	ginkgo.Context("CSI Replication Operations", func() {
		...
		ginkgo.It("should validate replication error handling", func(ctx context.Context) {
			...
			framework.Logf("  ⚠️  Setting replication-mode to 'invalid-mode' to test error handling")
			...
			framework.Logf("  ⚠️  [MOCK] Invalid mode 'invalid-mode' properly rejected")
			framework.Logf("  🛡️ [MOCK] Driver error handling working correctly")
